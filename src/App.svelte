<script lang="ts">
	...
	function onkeydown(event: KeyboardEvent) {
		...
		if (program_state.import_pool_overlay_open) {
			return;
		} else if (program_state.export_pool_overlay_open) {
			return;
		} else if (program_state.snapshot_overlay_open) {
			...
			return;
		} else if (program_state.tier_editor_open) {
